package hellokotlin.example.com.hellowkotlinexample.imageview
...
enum class PicassoBigCache {
    ...
    private fun init(ctx: Context?) {
        var ctx: Context? = ctx ?: throw IllegalStateException("Must provide context to init PicassoBigCache!") // fail fast
