...
import hellokotlin.example.com.hellowkotlinexample.BuildConfig
import hellokotlin.example.com.hellowkotlinexample.utils.ProgressUtils
import java.io.File
...
class ImagePicker(private val context: Context, private val imagePickerInterface: ImagePickerInterface?) {
    ...
    fun createImageChooser() {
        ...
        dialog.setSingleChoiceItems(cs, -1, DialogInterface.OnClickListener { dialog, which ->
            dialog.dismiss()
            if (which == 0) {
