package hellokotlin.example.com.hellowkotlinexample.utils
...
class PermissionUtils(private val context: Context) : ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    fun checkPermissions(permissionList: ArrayList<String>): Array<String?> {
        ...
        var permissions = arrayOfNulls<String>(arrPermission.size)
        permissions = arrPermission.toArray() as Array<String?>
        return permissions
    }
